  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/doctor/measurements', {
      ...
      body: JSON.stringify({
        ...
        rom_flexion_deg: num(form.rom_flexion_deg),
        rom_extension_deg: num(form.rom_extension_deg),
        rom_abduction_deg: num(form.rom_abduction_deg),
        rom_adduction_deg: num(form.rom_adduction_deg),
