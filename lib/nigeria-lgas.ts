export const NIGERIA_LGAS: Record<string, string[]> = {
  'Abia': [
    ...
    'Isiala Ngwa North', 'Isiala Ngwa South', 'Isuikwuato', 'Obi Nwa', 'Ohafia',
  ...
  'Akwa Ibom': [
    ...
    'Oron', 'Oruk Anam', 'Ukanafun', 'Udung Uko', 'Urue Offong/Oruko',
    'Uruan', 'Uyo',
  ],
  'Anambra': [
    'Aguata', 'Awka North', 'Awka South', 'Ayamelum', 'Dunukofia', 'Ekwusigo',
    'Idemili North', 'Idemili South', 'Ihiala', 'Njikoka', 'Nnewi North',
    'Nnewi South', 'Ogbaru', 'Onitsha North', 'Onitsha South', 'Orumba North',
    'Orumba South', 'Oyi', 'Anambra East', 'Anambra West', 'Anaocha',
  ],
  'Bauchi': [
  ...
  'Taraba': [
    'Ardo Kola', 'Bali', 'Donga', 'Gashaka', 'Gasso', 'Ibi', 'Jalingo',
