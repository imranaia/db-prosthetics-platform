      ...
      <div className="auth-card">
        ...
        <div style={{ margin: '24px 0 0' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <a
              href="/api/auth/apple"
              style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '11px', borderRadius: '9px', border: '1px solid var(--border-card)', background: 'linear-gradient(145deg, #1a1a1a, #000)', boxShadow: '2px 2px 6px rgba(0,0,0,0.15)', textDecoration: 'none', color: '#fff', fontSize: '0.875rem', fontWeight: 500, cursor: 'pointer' }}
            >
