...
// Only triggers if the root layout itself throws — a separate, more
// minimal fallback since it can't rely on RootLayout being intact enough
// to render around it.
          ...
          <div style={{ width: '100%', maxWidth: 480 }}>
            <div className="auth-card" style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '0.94rem', lineHeight: 1.65, color: 'var(--text-muted)', maxWidth: '34ch', margin: '0 auto 28px' }}>
                This isn&apos;t something you did. Our team has been notified automatically — please try again in a moment.
              </p>
