...
export default function ConsultationsPage() {
  ...
  function resetForm() {
    setForm({
      ...
      consultation_type: 'new', category: '', device_subtype: '',
    });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // A patient marked "not fit" shouldn't get a device order.
    ...
    if (goingToOrder && !user?.hasDoctorProfile) {
    ...
    const endpoint = goingToOrder ? '/api/doctor/consultations' : '/api/admin/consultations';
    ...
    if (fitDecision === 'fit' && newId) {
      ...
      const measurementRes = await fetch('/api/doctor/measurements', {
        ...
        body: JSON.stringify({
          ...
          rom_flexion_deg: num(measurementForm.rom_flexion_deg),
          rom_extension_deg: num(measurementForm.rom_extension_deg),
          rom_abduction_deg: num(measurementForm.rom_abduction_deg),
          rom_adduction_deg: num(measurementForm.rom_adduction_deg),
