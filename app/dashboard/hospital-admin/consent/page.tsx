...
export default function HospitalAdminConsentPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/hospital-admin/consent')
      .then(r => r.json())
      .then(data => {
        setForms(data.forms || []);
    ...
    <div className="dash-content">
      ...
      {dataLoading ? (
        ...
        <div className="skeu-card" style={{ padding: '60px 24px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '0.88rem', color: 'var(--text-muted)' }}>Consent forms for patients at your hospital will appear here.</div>
        </div>
      ) : (
