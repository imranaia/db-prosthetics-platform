        ...
        {editing ? (
          <form onSubmit={handleEditSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
              <div><label className="skeu-label" style={{ display: 'block', marginBottom: 4 }}>Full Name</label><input className="skeu-input" value={editForm.full_name} onChange={e => setEditForm({ ...editForm, full_name: e.target.value })} placeholder="Your name" /></div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div>
              ...
              <span style={{ background: '#1b3d5e18', color: 'var(--primary)', padding: '3px 12px', borderRadius: 20, fontSize: '0.8rem', fontWeight: 600 }}>
                Hospital Admin
              </span>
            </div>
          </div>
